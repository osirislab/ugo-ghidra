 ...
 */
public class UgoClangToken implements ClangNode {
    ...
    public UgoClangToken(ClangNode par) {
        parent = par;
        text = null;
        highlight = null;
    ...
    public UgoClangToken(ClangNode par, String txt) {
        parent = par;
        text = txt;
        highlight = null;
        syntax_type = getColor(null);
    ...
    public UgoClangToken(ClangNode par, String txt, String col) {
        parent = par;
        text = txt;
        highlight = null;
    ...
    static public ghidra.app.decompiler.ClangToken buildToken(ClangNode par, XmlPullParser parser,
        ...
        ghidra.app.decompiler.ClangToken token = null;
    ...
    static public ghidra.app.decompiler.ClangToken buildSpacer(ClangNode par, int indent, String indentStr) {
