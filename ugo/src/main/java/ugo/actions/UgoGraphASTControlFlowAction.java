...
public class UgoGraphASTControlFlowAction extends UgoAbstractDecompilerAction {
    private final UgoDecompilerController controller;
    private final PluginTool tool;

    public UgoGraphASTControlFlowAction(Plugin plugin, UgoDecompilerController controller) {
