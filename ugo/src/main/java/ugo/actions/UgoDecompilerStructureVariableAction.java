...
public class UgoDecompilerStructureVariableAction extends UgoCreateStructureVariableAction {

    public UgoDecompilerStructureVariableAction(String owner, PluginTool tool,
