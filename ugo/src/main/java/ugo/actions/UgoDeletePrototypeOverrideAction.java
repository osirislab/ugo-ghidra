...
public class UgoDeletePrototypeOverrideAction extends UgoAbstractDecompilerAction {
    private final UgoDecompilerController controller;

    public UgoDeletePrototypeOverrideAction(PluginTool tool, UgoDecompilerController controller) {
        super("Remove Signature Override");
        this.controller = controller;
        setPopupMenuData(new MenuData(new String[]{"Remove Signature Override"}, "Decompile"));
    }

    public static CodeSymbol getSymbol(UgoDecompilerController controller) {
