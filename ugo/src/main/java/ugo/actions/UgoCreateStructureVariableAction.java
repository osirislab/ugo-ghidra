...
public abstract class UgoCreateStructureVariableAction extends DockingAction {
    protected final UgoDecompilerController controller;
    private final PluginTool tool;

    public UgoCreateStructureVariableAction(String owner, PluginTool tool,
