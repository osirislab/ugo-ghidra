...
public class UgoRenameVariableAction extends UgoAbstractDecompilerAction {
    private final UgoDecompilerController controller;
    private final PluginTool tool;
    private RenameTask nameTask = null;

    public UgoRenameVariableAction(PluginTool tool, UgoDecompilerController controller) {
    ...
    public static HighVariable forgeHighVariable(Address addr, UgoDecompilerController controller) {
        ...
        if (addr.isStackAddress()) {
            ...
            if (data != null) {
                ...
                try {
                    ...
                    Msg.error(ghidra.app.plugin.core.decompile.actions.RenameVariableAction.class, e.getMessage());
                }
            }
        }
        return res;
