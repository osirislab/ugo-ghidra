...
public class UgoListingStructureVariableAction extends UgoCreateStructureVariableAction {

    public UgoListingStructureVariableAction(String owner, PluginTool tool,
