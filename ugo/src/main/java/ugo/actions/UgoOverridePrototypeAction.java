...
public class UgoOverridePrototypeAction extends UgoAbstractDecompilerAction {
    ...
    public UgoOverridePrototypeAction(PluginTool tool, UgoDecompilerController controller) {
     ...
     */
    public static PcodeOp getCallOp(UgoDecompilerController controller) {
