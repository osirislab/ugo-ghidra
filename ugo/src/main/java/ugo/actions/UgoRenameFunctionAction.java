...
public class UgoRenameFunctionAction extends UgoAbstractDecompilerAction {

    private final UgoDecompilerController controller;
    private final PluginTool tool;

    public UgoRenameFunctionAction(PluginTool tool, UgoDecompilerController controller) {
