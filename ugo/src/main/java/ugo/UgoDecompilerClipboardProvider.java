...
public class UgoDecompilerClipboardProvider extends ByteCopier
    ...
    UgoDecompilerProvider provider;
    ...
    public UgoDecompilerClipboardProvider(UgoDecompilePlugin plugin, UgoDecompilerProvider provider) {
