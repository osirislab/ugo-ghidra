...
public class UgoClangTextField extends WrappingVerticalLayoutTextField {
    ...
    public ClangToken getToken(FieldLocation loc) {
        ...
        if (clickedObject instanceof UgoClangFieldElement) {
            UgoClangFieldElement element = (UgoClangFieldElement) clickedObject;
