 ...
 */
public class UgoDecompilerPanel extends JPanel implements FieldMouseListener, FieldLocationListener,
    ...
    private UgoClangLayoutController layoutMgr;
    private HighlightFactory hlFactory;
    private UgoClangHighlightController highlightController;
    ...
    private final UgoDecompilerClipboardProvider clipboard;
    ...
    UgoDecompilerPanel(UgoDecompilerController controller, DecompileOptions options,
                       UgoDecompilerClipboardProvider clipboard, JComponent taskMonitorComponent) {
        ...
        layoutMgr = new UgoClangLayoutController(options, this, metrics, hlFactory);
    ...
    private void tryToGoto(FieldLocation location, Field field, MouseEvent event,
        ...
        UgoClangTextField textField = (UgoClangTextField) field;
    ...
    private void tryGoToComment(FieldLocation location, MouseEvent event, UgoClangTextField textField,
...
//==================================================================================================
    ...
    public void setHighlightController(UgoClangHighlightController highlightController) {
